...
def load_avro_schema_from_file():
    key_schema = avro.load("week_6/avro_example/taxi_ride_key.avsc")
    value_schema = avro.load("week_6/avro_example/taxi_ride_value.avsc")
...
def send_record():
    ...
    file = open('week_6/avro_example/yellow_tripdata_2020-01.csv')
